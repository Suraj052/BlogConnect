...
import com.example.blog.databinding.FragmentCategoryTravelBinding

import retrofit2.HttpException
import java.io.IOException

private var _binding : FragmentCategoryTravelBinding? = null
private val binding get() = _binding!!

class CategoryFragmentTravel() : Fragment() {
    ...
    override fun onCreateView(
        ...
        _binding = FragmentCategoryTravelBinding.inflate(inflater,container,false)
        ...
        lifecycleScope.launchWhenCreated {
            ...
            val response = try {
                ApiClient.userService.getCategoryTravel()
            }catch (e: IOException){
